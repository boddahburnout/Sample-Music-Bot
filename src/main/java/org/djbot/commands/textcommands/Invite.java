...
public class Invite extends Command {
    ...
    protected void execute(CommandEvent event) {
        ...
        String linkText = "Click to invite to a server";

        String message = "You can invite me by clicking the link below:\n\n" +
                "[" + linkText + "](" + inviteUrl + ")";

        channel.sendMessageEmbeds(EmbedWrapper.createInfo(message, color)).queue();
    }
}
