    ...
    protected void execute(SlashCommandEvent slashCommandEvent) {
         ...
         if (optionMapping != null) {
             ...
             try {
                 ...
                 slashCommandEvent.replyEmbeds(EmbedWrapper.createInfo("Message color has been set", Color.decode(hexColor))).queue();
             } catch (NumberFormatException e) {
                 configData.setGuildColor(slashCommandEvent.getGuild().getIdLong(), "0xFFFFFF");
                 slashCommandEvent.replyEmbeds(EmbedWrapper.createInfo("Message color has been set", Color.decode( "0xFFFFFF"))).queue();
             }
         }
    }
}
